...
# from external route
#
while true; do curl ${MY_SM_ROUTE}; sleep 1; done
while true; do curl ${MY_SM_ROUTE}/customer; sleep 1; done
while true; do curl ${MY_SM_ROUTE}/recommendation; sleep 1; done
